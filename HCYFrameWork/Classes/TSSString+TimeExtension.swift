...
public class TSSStringWithTime: NSObject {
    ...
    public static func dateConvertString(date:Date) -> String {
        ...
        let moth = TSSStringWithTime.backmonth(formatter.string(from: date))
    ...
    private func convertDateString(string: String) -> String{
        let date = TSSStringWithTime.stringConvertDate(string: string)
        let tempString = TSSStringWithTime.dateConvertString(date: date)
        return tempString
    }
