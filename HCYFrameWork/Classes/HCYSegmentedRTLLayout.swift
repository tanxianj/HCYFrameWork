...
public protocol HCYSegmentedViewRTLCompatible: class {
    func segmentedViewShouldRTLLayout() -> Bool
    func segmentedView(horizontalFlipForView view: UIView?)
}

public extension HCYSegmentedViewRTLCompatible {
...
class HCYSegmentedRTLCollectionCell: UICollectionViewCell, HCYSegmentedViewRTLCompatible {
