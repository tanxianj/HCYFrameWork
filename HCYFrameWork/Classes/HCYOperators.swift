...
@discardableResult
func <=> <Base>(relay: BehaviorRelay<String>,textInput: TextInput<Base>) -> Disposable {
    let bindToUIDisposable = relay.bind(to: textInput.text)
...
@discardableResult
func => <Base>(Input: PublishSubject<Base>, relay: PublishSubject<Base>) -> Disposable {
    let bindToUIDisposable = Input.bind(to: relay)
    return Disposables.create([bindToUIDisposable])
}
@discardableResult
func => <Base>(Input: Observable<Base>, relay: PublishSubject<Base>) -> Disposable {
    let bindToUIDisposable = Input.bind(to: relay)
    return Disposables.create([bindToUIDisposable])
}
//=> 单向绑定
...
//=> 单向绑定
@discardableResult
func => <Base>(textInput: TextInput<Base>, relay: Binder<String?>) -> Disposable {
    let bindToUIDisposable = textInput.text.orEmpty.bind(to: relay)
    return Disposables.create([bindToUIDisposable])
}
//=> 单向绑定
@discardableResult
func => <Base>(Input: ControlProperty<Base>, relay: Binder<Base?>) -> Disposable {
    let bindToUIDisposable = Input.bind(to: relay)
    return Disposables.create([bindToUIDisposable])
}
//=> 单向绑定
@discardableResult
func => <Base>(Input: Observable<Base>, relay: Binder<Base>) -> Disposable {
    let bindToUIDisposable = Input.bind(to: relay)
    return Disposables.create([bindToUIDisposable])
}
//=> 单向绑定
