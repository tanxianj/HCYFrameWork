...
public typealias HCYSegmentedCellSelectedAnimationClosure = (CGFloat)->()

open class HCYSegmentedBaseCell: UICollectionViewCell, HCYSegmentedViewRTLCompatible {
    open var itemModel: HCYSegmentedBaseItemModel?
    open var animator: HCYSegmentedAnimator?
    private var selectedAnimationClosureArray = [HCYSegmentedCellSelectedAnimationClosure]()
    ...
    open func canStartSelectedAnimation(itemModel: HCYSegmentedBaseItemModel, selectedType: HCYSegmentedViewItemSelectedType) -> Bool {
    ...
    open func appendSelectedAnimationClosure(closure: @escaping HCYSegmentedCellSelectedAnimationClosure) {
        selectedAnimationClosureArray.append(closure)
    }

    open func startSelectedAnimationIfNeeded(itemModel: HCYSegmentedBaseItemModel, selectedType: HCYSegmentedViewItemSelectedType) {
    ...
    open func reloadData(itemModel: HCYSegmentedBaseItemModel, selectedType: HCYSegmentedViewItemSelectedType) {
