...
public class TSSButton:UIButton{
...
extension UIButton{
    ...
    typealias tss_btn_Action = ()->()
    var btnAction:tss_btn_Action{
        get{
            return (objc_getAssociatedObject(self, &BTNACTION_KEY) as? UIButton.tss_btn_Action)!
        }
        set{
