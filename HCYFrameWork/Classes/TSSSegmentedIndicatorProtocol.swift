...
public protocol TSSSegmentedIndicatorProtocol {
    ...
    func refreshIndicatorState(model: TSSSegmentedIndicatorSelectedParams)
    ...
    /// param percent 过渡百分比
    /// - Parameter model: model description
    func contentScrollViewDidScroll(model: TSSSegmentedIndicatorTransitionParams)
    ...
    /// - Parameter model: model description
    func selectItem(model: TSSSegmentedIndicatorSelectedParams)
}
