...
import UIKit
import RxSwift
public class HCYBasePopupViewManager{
    private static var _sharedInstance:HCYBasePopupViewManager?
    
    /// 单列
    /// - Returns: BasePoputView
    public class func sharedInstance()->HCYBasePopupViewManager{
        guard let Instance = _sharedInstance else {
            _sharedInstance = HCYBasePopupViewManager()
    ...
    public func deInstance(){
        HCYBasePopupViewManager._sharedInstance = nil
    }
...
extension HCYBasePopupViewManager{
...
class BasePoputEvents{
    static let shared = BasePoputEvents()
    ...
    func sendToPoputView(index:Int){
        HCYBasePopupViewManager.sharedInstance().hidden()
        HCYBasePopupViewManager.sharedInstance().contentViewAction(index)
    }
}
