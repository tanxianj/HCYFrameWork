...
public protocol TSSSegmentedViewRTLCompatible: class {
    func segmentedViewShouldRTLLayout() -> Bool
    func segmentedView(horizontalFlipForView view: UIView?)
}

public extension TSSSegmentedViewRTLCompatible {
...
class TSSSegmentedRTLCollectionCell: UICollectionViewCell, TSSSegmentedViewRTLCompatible {
