...
open class HCYDefaultView: UIView {
    let hcy_Space:CGFloat = 10.0
    //主要点击事件
    ...
    private lazy var switchActivity:HCYLoadingCircle = {
        let switchActivity = HCYLoadingCircle()
...
extension HCYDefaultView{

    public static func loadingViewWithDefaultRefreshingBlock(mainAction: refreshingBlock = nil,subviewsBlock:subviewsBlock = nil) ->HCYDefaultView {
        let  view = HCYDefaultView()
    ...
    public static func loadingViewWith(subviews:[UIView],
                               ...
                               subviewsBlock:subviewsBlock = nil) ->HCYDefaultView {
        let  view = HCYDefaultView()
