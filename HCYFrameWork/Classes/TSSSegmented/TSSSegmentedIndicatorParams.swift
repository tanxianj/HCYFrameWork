 ...
 */
public struct TSSSegmentedIndicatorSelectedParams {
    public let currentSelectedIndex: Int
    public let currentSelectedItemFrame: CGRect
    public let selectedType: TSSSegmentedViewItemSelectedType
    public let currentItemContentWidth: CGFloat
    /// collectionView的contentSize
    public var collectionViewContentSize: CGSize?

    public init(currentSelectedIndex: Int, currentSelectedItemFrame: CGRect, selectedType: TSSSegmentedViewItemSelectedType, currentItemContentWidth: CGFloat, collectionViewContentSize: CGSize?) {
...
public struct TSSSegmentedIndicatorTransitionParams {
    public let currentSelectedIndex: Int
