...
public protocol HCYSegmentedIndicatorProtocol {
    ...
    func refreshIndicatorState(model: HCYSegmentedIndicatorSelectedParams)
    ...
    /// param percent 过渡百分比
    /// - Parameter model: model description
    func contentScrollViewDidScroll(model: HCYSegmentedIndicatorTransitionParams)
    ...
    /// - Parameter model: model description
    func selectItem(model: HCYSegmentedIndicatorSelectedParams)
}
